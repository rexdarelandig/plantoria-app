  ...
  return raw
    .map((item): TreflePlantSearchItem | null => {
      ...
      return {
        id: item.id,
        scientific_name:
          typeof item.scientific_name === "string" ? item.scientific_name : null,
        common_name:
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSearch} className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="plant-lookup">Search Trefle</Label>
            <Input
              id="plant-lookup"
              value={lookupQuery}
              onChange={(ev) => {
          ...
          <Button type="submit" disabled={searchLoading || !lookupQuery.trim()}>
